...
const translations: Record<Language, any> = {
  es: {
    ...
    filter: {
        ...
        kitchenAndSurveillance: 'Cocina y Vigilancia',
        kitchen: {
            any: 'Cualquier cocina',
            integral: 'Integral',
            semi_integral: 'Semi-integral',
            sencilla: 'Sencilla',
        },
        surveillance: {
            any: 'Cualquier vigilancia',
            guard: 'Celador',
            private: 'Privada',
            police: 'Policía',
            none: 'Ninguna',
    ...
    features: {
        ...
        securityGate: 'Reja de Seguridad',
    ...
    propertyModal: {
        ...
        share: 'Compartir',
        copied: '¡Copiado!',
        shareText: 'Echa un vistazo a esta propiedad: {title}',
        generateQr: 'Generar Código QR',
        qrTitle: 'Código QR de la Propiedad',
        download: 'Descargar',
        close: 'Cerrar',
    },
    about: {
  ...
  en: {
    ...
    filter: {
        ...
        kitchenAndSurveillance: 'Kitchen & Surveillance',
        kitchen: {
            any: 'Any kitchen',
            integral: 'Integral',
            semi_integral: 'Semi-integral',
    ...
    propertyModal: {
        ...
        share: 'Share',
        copied: 'Copied!',
        shareText: 'Check out this property: {title}',
        generateQr: 'Generate QR Code',
        qrTitle: 'Property QR Code',
        download: 'Download',
        close: 'Close',
    },
    about: {

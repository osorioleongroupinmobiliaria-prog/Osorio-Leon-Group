  ...
  es: {
    ...
    chatbot: {
        ...
        answers: {
            ...
            contactInfo: `Puedes comunicarte con nosotros a los teléfonos: 3212780607 o 3115673740. Nuestra oficina está en la Oficina 301, Edificio Torre Plaza 62, Calle 62# 23-61. Para una atención más directa, te recomiendo usar el botón de WhatsApp.`,
            ...
            whoAreYou: 'Somos OSORIO & LEON GROUP, una agencia inmobiliaria con amplia trayectoria en Manizales y el Eje Cafetero. Nos destacamos por la transparencia, experiencia y confianza en todos nuestros servicios.',
            ...
            adminServiceIncludes: 'Nuestro servicio de administración incluye: Comercialización, manejo de contratos, búsqueda y perfilación de arrendatarios, inventario digital, recaudo, manejo de afianzas y mucho más. Es un servicio muy completo.',
            locativeRepairs: 'Realizamos reparaciones locativas con personal calificado, siempre con la autorización previa y por escrito del propietario.',
            adminFeePayment: 'Sí, nos encargamos del pago mensual de la cuota ordinaria de administración de la copropiedad para evitar cualquier mora.',
            adminServiceFee: 'Nuestros honorarios de administración son del 10% más IVA (19%) sobre el canon mensual y la cuota de administración (si aplica).',
            guaranteeFee: 'El valor de la afianza es del 2.5% mensual más IVA sobre el valor del canon, cuota de administración e IVA (si es comercial).',
            ...
            docsNaturalPerson: 'Como persona natural, necesitas radicar tu Cédula al 150%, RUT, Certificado de Tradición y Libertad, último impuesto predial, autorización de pago, certificación bancaria, y otros documentos si es propiedad horizontal.',
            docsLegalEntity: 'Como persona jurídica, necesitas el Certificado de Cámara y Comercio, Cédula del Representante Legal, RUT, Certificado de Tradición y Libertad, y otros documentos similares a los de persona natural.',
            phoneLinesPolicy: 'No arrendamos propiedades con líneas telefónicas a nombre del propietario. Sugerimos que el arrendatario contrate su propio servicio.',
            ...
            rentIncreaseHousing: 'Para vivienda, el incremento anual del canon corresponde al IPC (Índice de Precios al Consumidor) del año anterior.',
            ...
            infoForSaleListing: 'Para poner tu inmueble en venta, necesitamos detalles como la dirección, área, características (habitaciones, baños, etc.), estado y el precio de venta deseado.',
    ...
    contact: {
     ...
     chatbot: {
        ...
        answers: {
            ...
            contactInfo: `You can reach us at 3212780607 or 3115673740. Our office is at Office 301, Torre Plaza 62 Building, Calle 62# 23-61. For more direct assistance, I recommend using the WhatsApp button.`,
            ...
            whoAreYou: 'We are OSORIO & LEON GROUP, a real estate agency with extensive experience in Manizales and the Coffee Axis. We are known for our transparency, expertise, and the trust we build in all our services.',
            ...
            adminServiceIncludes: 'Our management service includes: Marketing, contract handling, tenant screening, digital inventory, rent collection, guarantee management, and much more. It is a very comprehensive service.',
            ...
            adminFeePayment: 'Yes, we handle the monthly payment of the ordinary administration fee for the co-ownership to avoid any arrears.',
            adminServiceFee: 'Our administration fees are 10% plus VAT (19%) on the monthly rent and the administration fee (if applicable).',
            guaranteeFee: 'The cost of the guarantee is 2.5% per month plus VAT on the value of the rent, administration fee, and VAT (if commercial).',
            ...
            docsNaturalPerson: 'As a natural person, you need to submit your ID at 150%, RUT, Certificate of Title and Freedom, last property tax bill, payment authorization, bank certification, and other documents if it is a horizontal property.',
            docsLegalEntity: 'As a legal entity, you need the Certificate of Chamber of Commerce, CEO\'s ID, RUT, Certificate of Title and Freedom, and other documents similar to those for a natural person.',
            phoneLinesPolicy: 'We do not rent properties with telephone lines in the owner\'s name. We suggest that the tenant contracts their own service.',
            guaranteeStudyPayer: 'The cost of the documentation study by the guarantor (Datafianza) is borne by the prospective tenant.',
            rentIncreaseHousing: 'For residential housing, the annual rent increase corresponds to the CPI (Consumer Price Index) of the previous year.',
            ...
            infoForSaleListing: 'To list your property for sale, we need details such as the address, area, features (bedrooms, bathrooms, etc.), condition, and the desired sale price.',
